// 来源：https://assetstore.unity.com/packages/tools/gui/modern-ui-pack-201717。
// 遵循：Standard Unity Asset Store EULA。
...
namespace eraUni.View
{
    ...
    /// 为 UI 添加渐变效果。
    /// </summary>
    [AddComponentMenu("eraUni/UI/Effects/Gradient")]
    public class UIGradient : BaseMeshEffect
    {
        [SerializeField]
        Gradient _effectGradient = new Gradient() { colorKeys = new GradientColorKey[] { new GradientColorKey(Color.black, 0), new GradientColorKey(Color.white, 1) } };
